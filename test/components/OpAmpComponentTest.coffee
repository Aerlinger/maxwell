describe "OpAmp Component", ->
  describe "default initialization", ->
    ...
    it "has default method return values", ->
      expect(@cc2Elm.getPostCount()).to.equal 3
      ...
      expect(@cc2Elm.getInternalNodeCount()).to.equal 0
  ...
  describe "With params array", ->
    before ->
      @cc2Elm = new OpAmpElm(50, 75, 50, 150, ["15.0", "-15.0", 1e7])
    ...
    it "can be stringified", ->
      expect(@cc2Elm.toString()).to.eql("""OpAmpElm@[98 123 98 198]: {"maxOut":15,"minOut":-15,"gbw":10000000}""")
    ...
    describe "Loading list of parameters", ->
      before ->
        @cc2Elm = new OpAmpElm(100, 200, 100, 300, [-10, 10, 1e4])
