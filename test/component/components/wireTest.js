...
(function() {
  define(['cs!WireElm', 'cs!Circuit', 'cs!MatrixStamper'], function(WireElm, Circuit, MatrixStamper) {
    return describe("Wire Component", function() {
      ...
      return describe("after soldering to circuit", function() {
        ...
        it("should be stampable", function() {
          return this.wireElm.stamp(this.Stamper);
        });
        it("is steppable", function() {
          return this.wireElm.doStep();
        });
        it("is drawable", function() {});
        return it("correctly setPoints", function() {
