...
(function() {
  define(['cs!Polygon', 'cs!Rectangle', 'cs!Point'], function(Polygon, Rectangle, Point) {
    ...
    return describe("Rectangle", function() {
      ...
      it("is not equal a rectangle of different dimension", function() {
        var congruentRect;
        congruentRect = new Rectangle(5, 6, 100, 151);
        return this.rect.equals(congruentRect).should.equal(false);
      });
      it("is not be able to detect points on its border", function() {
      ...
      it("is not detect intersections with other rectangles with non-intersecting borders", function() {
